...
X_train = training.drop(columns=['Wrec', 'Neta'])
y_train = training['Wrec', 'Neta']
X_test = testing.drop(columns=['Wrec', 'Neta'])
y_test = testing['Wrec', 'Neta']

# Identify categorical columns
categorical_cols = ['TDA', 'TDB']
